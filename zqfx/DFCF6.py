...
class HsxyCasUtil(object):
    ...
    def get_list(self):
        ...
        url = "https://member.neea.cn/login/new?returnUrl=http%3A%2F%2Forder.neea.cn%2FreadingAgreement%2FtoAgreement%3FproId%3D13%26articleId%3D1475%26cbd%3Dknight"
        headers = {
